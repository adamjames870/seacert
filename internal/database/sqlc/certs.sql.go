...
RETURNING id, created_at, updated_at, cert_number, issued_date, cert_type_id, alternative_name, remarks, issuer_id, user_id, manual_expiry, deleted, document_path
`
...
SET
    ...
    document_path=COALESCE($10, document_path),
